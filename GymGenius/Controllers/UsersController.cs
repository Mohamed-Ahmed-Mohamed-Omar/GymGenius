    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<IActionResult> ShowProfile()
        {
            ...
            var profile = new ProFileVM
            {
                ...
                ProfilePhoroUrl = user.ProfilePhoroUrl,
                UserName = user.UserName
            };

            if (await _userManager.IsInRoleAsync(user, clsRoles.roleCoach))
            {
        ...
        public async Task<IActionResult> updateProfile([FromBody] ProFileVM model)
        {
            ...
            if (!string.IsNullOrEmpty(model.ProfilePhoroUrl))
            {
                user.ProfilePhoroUrl = model.ProfilePhoroUrl;
            }
